        ...
        <div class="flex items-center justify-start">
            <div class="relative">
                ...
                <svg @click="showInp = true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    stroke-width="1.5" stroke="currentColor" class="size-12 p-1.5 absolute bottom-3 border-4 border-white right-3 bg-yellow-300  flex items-center justify-center text-lg cursor-pointer rounded-full transition hover:bg-yellow-400">
