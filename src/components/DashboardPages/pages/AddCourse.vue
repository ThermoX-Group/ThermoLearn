        ...
        <div class="grid grid-cols-1 mt-5 gap-5 md:grid-cols-2">
            <div>
                ...
                <input type="text" id="name" placeholder="نام دوره را وارد کنید..."
                    class="block bg-base-100 w-full border-2 border-base-300 rounded-full p-2 outline-yellow-300 mt-2"
            ...
            <div>
                ...
                <textarea id="des" placeholder="توضیحات دوره را وارد کنید..."
                    class="block bg-base-100  w-full border-2 border-base-300 rounded-xl p-2 outline-yellow-300 mt-2"
            ...
            <div>
                ...
                <input type="text" id="teacher" placeholder="مدرس دوره را وارد کنید..."
                    class="block bg-base-100  w-full border-2 border-base-300 rounded-full p-2 outline-yellow-300 mt-2 cursor-not-allowed" disabled
            ...
            <div>
                ...
                <input type="text" id="img" placeholder="مدرس دوره را وارد کنید..."
                    class="block bg-base-100  w-full border-2 border-base-300 rounded-full p-2 outline-yellow-300 mt-2" v-model=courseData.img>
            </div>
        </div>
        <div class="mt-5">
            <div>
                ...
                <div class="flex items-center gap-5 flex-col md:flex-row">
                    <input type="text" id="seasons" placeholder="سرفصل های دوره را وارد کنید..."
                        class="w-full bg-base-100 border-2 border-base-300 rounded-full p-2 outline-yellow-300 mt-2 md:w-3/4"
