<template>
    <div class="fixed top-0 right-0 w-full h-full z-20">
        ...
        <div
            class="bg-yellow-100 absolute top-1/2 right-1/2 translate-x-1/2 -translate-y-1/2 py-3 px-5 rounded-xl w-2/3 h-3/4 overflow-scroll lg:w-1/2 lg:h-auto lg:overflow-visible">
            ...
            <div class="mt-3 grid grid-cols-1 gap-2 lg:grid-cols-2">
                <div class="flex  flex-col justify-between">
                    <div>
                        ...
                        <input type="text" id="name" class="w-full border-2 rounded-full p-2 outline-yellow-300 mt-2"
                    ...
                    <div>
                        ...
                        <input type="text" id="reprerequisite"
                            class="w-full border-2 rounded-full p-2 outline-yellow-300 mt-2"
                            placeholder="پیش نیاز دوره را وارد کنید..." v-model="courseData.courseReprerequisite">
                    </div>
                    <div>
                        <label for="cover">کاور دوره</label>
                        <input type="text" id="cover" class="w-full border-2 rounded-full p-2 outline-yellow-300 mt-2"
                ...
                <div>
                    ...
                    <input type="number" id="price" class="w-full border-2 rounded-full p-2 outline-yellow-300 mt-2"
                        placeholder="قیمت دوره را وارد کنید..." v-model="courseData.coursePrice">
                </div>
                <div>
                    <label for="time">مدت زمان تقریبی دوره</label>
                    <input type="number" id="time" class="w-full border-2 rounded-full p-2 outline-yellow-300 mt-2"
            ...
            <div>
                ...
                <input type="text" id="teacher"
                    class="w-full bg-white border-2 rounded-full p-2 outline-yellow-300 mt-2"
                    placeholder="مدرس دوره را وارد کنید..." v-model="courseData.courseTeach">
            </div>
            <button @click="updateReqFunc"
                class="w-full rounded-full transition bg-yellow-300 border-2 border-yellow-300 hover:bg-yellow-100 hover:border-yellow-300 mt-4 p-2">
                <slot></slot>
            </button>
        </div>
    </div>
