<template>
    <div class="bg-yellow-300 w-1/5 fixed h-screen pt-3 pr-3 flex flex-col justify-between">
        <div>
            ...
            <ul class="mt-7">
                ...
                <li class="text-xl mb-2">
                    <router-link
                        class="hover:bg-yellow-200 py-3 px-5 transition flex items-center gap-2  rounded-tr-full rounded-br-full"
                        to="/dashboard/CoursePage"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
        ...
        <div class="flex flex-col items-center ml-3 text-xl mb-3 rounded-tr-xl rounded-tl-xl" v-else-if="userDatas">
